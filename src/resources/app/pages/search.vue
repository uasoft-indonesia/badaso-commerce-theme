            ...
            <div class="grid grid-cols-6 gap-4 w-full h-full">
                ...
                <div class="col-start-2 col-end-7 flex flex-wrap items-start h-max">
                    ...
                    <div class="flex bg-gray-200 h-12 items-center px-4 gap-4 rounded-xl w-full">
                        ...
                        <div class="relative md:max-w-52 max-w-32 w-full">
                            ...
                            <transition>
                                <div v-if="priceFilter" class="w-full absolute left-0 right-0 -bottom-18 shadow rounded-md z-70 bg-white">
                                    <div
                                        :class="[sort === 'price' && type === 'asc' ? 'text-primary' : '']"
                                    ...
                                    <div
                                        :class="[sort === 'price' && type === 'desc' ? 'text-primary' : '']"
                        ...
                        <div class="flex-grow" />
                        <div class="text-sm"><span class="text-primary">{{ products.currentPage }}</span>/{{ products.lastPage }}</div>
                        <div class="flex">
            ...
            <div class="p-3 w-full flex flex-col gap-2">
              ...
              <div class="grid grid-cols-2 gap-2 w-full items-center justify-center">
                ...
                <div @click="rating = 1" :class="[rating === 1 ? 'border border-primary' : '']" class="bg-gray-100 p-2 text-xs flex justify-center rounded-md text-center">Bintang 1 ke atas</div>
                    ...
                    <div class="w-full flex justify-between mt-3 text-sm bg-white text-gray-400">
                        ...
                        <div @click="applyFilterSortPrice(type === 'desc' ? 'asc' : 'desc')" class="py-3 text-center w-1/4 flex items-center justify-center gap-2" :class="[sort === 'price' ? 'text-primary border-b-2 border-primary' : '']">
                            ...
                            <template v-else>
                                <svg xmlns="http://www.w3.org/2000/svg" v-if="type === 'asc'" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 11l5-5m0 0l5 5m-5-5v12" />
                                </svg>

                                <svg xmlns="http://www.w3.org/2000/svg" v-else class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      return this.$_.filter(this.productCategories, (o) => {
        ...
        methods: {
            ...
            applyFilterSort(sort) {
                ...
                this.type = "desc";
                this.$inertia.visit(
                    this.route("badaso.commerce-theme.search", {
                        ...this.queryParams(),
                        sort,
                    })
                );
