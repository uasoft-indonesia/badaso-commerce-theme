    ...
    <div class="px-6">
      ...
      <div class="bg-white rounded-xl border-t border-dotted">
        ...
        <div class="flex justify-between items-center text-sm bg-primary bg-opacity-5 rounded-b-xl text-gray-700 px-6 py-4">
          ...
          <Link :href="route('badaso.commerce-theme.detail', order.orderDetails[0].productDetail.product.slug)" class="block text-center text-sm bg-primary text-white py-2 rounded-md w-40 font-medium hover:brightness-90 bg-blend-darken filter">Beli Lagi</Link>
        </div>
      </div>
