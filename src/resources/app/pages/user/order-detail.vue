  ...
  <div>
      ...
      <div class="pt-8 container grid grid-cols-profile">
        ...
        <div class="px-6">
          <div class="flex justify-between px-4 items-center text-sm bg-white rounded-xl text-gray-700">
            <Link :href="route('badaso.commerce-theme.order')" class="my-4 cursor-pointer text-center uppercase flex items-center">
          ...
          <div class="bg-white rounded-xl border-t border-dotted">
            ...
            <div class="flex justify-between items-center text-sm bg-primary bg-opacity-5 rounded-b-xl text-gray-700 px-6 py-4">
              ...
              <Link v-if="order.orderDetails.length > 0" :href="route('badaso.commerce-theme.detail', order.orderDetails[0].productDetail.product.slug)" class="block text-center text-sm bg-primary text-white py-2 rounded-md w-40 font-medium hover:brightness-90 bg-blend-darken filter">Beli Lagi</Link>
            </div>
          </div>
          ...
          <div class="bg-gray-50 py-4 px-6">
            ...
            <div class="flex w-full flex-col">
              <Link :href="route('badaso.commerce-theme.detail', orderDetail.productDetail.product.slug)" class="flex space-x-4 w-full py-4 first:border-t border-b last:border-b-0 last:pb-0 items-start" v-for="orderDetail, index in order.orderDetails" :key="index">
    ...
    <div class="block relative sm:hidden">
      <div class="fixed bottom-0 left-0 right-0 p-2 bg-white" v-if="order.status === 'done'">
        <Link class="block bg-primary text-white py-2 text-center rounded-md text-sm" :href="route('badaso.commerce-theme.detail', order.orderDetails[0].productDetail.product.slug)" v-if="order.orderDetails.length > 0">Beli Lagi</Link>
      </div>
    ...
    <div class="block sm:hidden">
      <div class="flex flex-col w-full">
        ...
        <div class="mt-3 bg-white w-full">
          <Link :href="route('badaso.commerce-theme.detail', orderDetail.productDetail.product.slug)" v-for="orderDetail, index in order.orderDetails" :key="index" class="flex flex-row p-2 last:border-b-0 gap-2">
            <div class="w-1/4">
