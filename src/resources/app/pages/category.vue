    ...
    <div class="grid grid-cols-6 gap-4 w-full h-full">
      ...
      <div class="col-start-1 row-span-full flex flex-wrap gap-6 mb-auto">
        ...
        <div class="flex w-full flex-wrap gap-3">
          ...
          <button class="w-full bg-primary text-white p-1 text-sm uppercase rounded-sm">
            Terapkan
          </button>
        </div>
        ...
        <div class="flex w-full flex-wrap gap-3 select-none opacity-30 cursor-default">
          <div href="#" class="text-gray-600 w-full font-semibold text-sm flex items-center relative">
            Penilaian
          </div>
          <div class="flex gap-2 flex-wrap">
            ...
            <!-- 5 STARS -->
            <a href="#" class="w-auto flex gap-1 items-center">
        ...
        <button class="w-full bg-primary text-white uppercase text-sm p-1 rounded-sm">
          Hapus Semua
        </button>
      </div>
      ...
      <div class="col-start-2 col-end-7 flex flex-wrap items-start h-max">
        <div class="flex bg-gray-200 h-12 items-center px-4 gap-4 rounded-xl w-full">
          ...
          <div class="flex-grow" />
          <div class="text-sm">
            <span class="text-primary">1</span>/100
          </div>
          <div class="flex">
        ...
        <div class="w-full py-2 grid grid-cols-5 h-full gap-2">
          <!-- <a href="#" v-for="index in 30" :key="index" class="relative transition-all ease duration-200 group bg-white ring-primary rounded-xl h-full hover:shadow-md transform hover:-translate-y-1 shadow-sm">
            ...
            <div class="px-4 pb-2">
              ...
              <div class="flex items-end py-2">
                <div class="text-primary font-medium line-clamp-1">
                  <small class="font-light">RP</small>165.000<small class="font-light"> - RP</small>200.000
                </div>
              </div>
              <div class="flex justify-between">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-500" viewBox="0 0 20 20" fill="transparent" stroke="currentColor">
                  <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd" />
                </svg>
                <div class="flex items-center">
                  <div class="flex mr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-yellow-500" viewBox="0 0 20 20" fill="currentColor" v-for="index in 5" :key="index">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  </div>
                  <span class="text-xs">10RB Terjual</span>
                </div>
              </div>
              <div class="flex items-start text-xs mt-1 font-light text-gray-500 justify-end">KOTA JAKARTA UTARA</div>
            </div>
          </a> -->
