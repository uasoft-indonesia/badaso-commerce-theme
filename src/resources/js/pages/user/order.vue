    ...
    <div class="pr-8">
      <div class="h-22 flex items-center border-b">
        ...
        <div class="inline-block flex-wrap pl-2">
          <div class="text-sm font-medium w-full line-clamp-1 text-gray-700">Admin</div>
          ...
          <div class="flex flex-wrap bg-white rounded-xl p-4">
            <div class="flex w-full justify-end items-center pb-4">
              <div class="flex space-x-2 items-center">
                ...
                <router-link :to="{ name: 'OrderDetail', params: { id: '80746114475257' } }" class="text-sm text-gray-500">Paket telah diterima</router-link>
              </div>
              <div class="flex ml-3 items-center divide-x">
                <tooltip class="pr-2 flex items-center justify-center" placement="right" popoverBaseClass="before:top-arrow-center after:top-arrow-center mr-2 arrow-right" trigger="hover">
                ...
                <span class="text-sm text-primary pl-2 tracking-wide">SELESAI</span>
              </div>
            </div>
            <router-link :to="{ name: 'OrderDetail', params: { id: '80746114475257' } }" class="flex w-full flex-col">
              <div class="flex space-x-4 w-full py-4 first:border-t border-b last:border-b-0 last:pb-0 items-start" v-for="index in 3" :key="index">
                <img :src="`https://picsum.photos/seed/${index}/80/80`" class="border">
                <div class="flex flex-col">
                  <div class="text-gray-700">Lorem ipsum dolor sit amet.</div>
                  <div class="text-sm text-gray-600">x{{ index }}</div>
                </div>
                <div class="flex-grow" />
                <div class="self-center text-primary flex items-center">
                  <div class="text-gray-300 mr-2 text-sm line-through" v-if="index == 2">Rp320.000</div>
                  Rp170.000
                </div>
              </div>
            </router-link>
          ...
          <div class="bg-white border-t border-dotted p-6 rounded-xl shadow-sm flex flex-nowrap justify-between">
            ...
            <div class="flex flex-col space-y-4 items-end">
              <div class="flex space-x-3 items-center">
                ...
                <div class="text-2xl text-primary">Rp508.000</div>
              </div>
              <div class="flex items-center space-x-2">
                <button class="text-sm bg-primary text-white py-2 rounded-md w-40 font-medium hover:brightness-90 bg-blend-darken filter">Nilai</button>
